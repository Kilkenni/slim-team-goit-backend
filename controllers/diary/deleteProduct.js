...
const deleteProduct = async (req, res) => {
    ...
    if(userDiary){
        ...
        const updateForDeleteProduct = { $pull: { productList: { _id: productId } } }
        const optionsForDeleteProduct = { safe: true, multi: false }
        await Diary.findOneAndUpdate(filterForDeleteProduct, updateForDeleteProduct, optionsForDeleteProduct) 
